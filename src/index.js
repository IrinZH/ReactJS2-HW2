...
function () {
  ...
  _createClass(MakeBusiness, [{
    ...
    value: function showResults() {
      ...
      (_console = console).log.apply(_console, _toConsumableArray(_cash.sumSponsors));
...
var makeBusiness = new MakeBusiness('Sam', undefined, _cash.money, _employers.employersNames);
